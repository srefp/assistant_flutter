...
| findPic   | 找图，在某个区域找图，与图片功能组合使用             | `findPic([12345, 12345, 54321, 54321], 'picKey')`           |
| findPic   | 找图，在某个区域找图，限定时间内循环找图，找到后结束 | `findPic([12345, 12345, 54321, 54321], 'picKey', 10, 2000)` |
...
// 参数2：'pic' 是你要找的图片的键
const [ match, loc, find ] = findPic([43820, 0, 51605, 3794], 'pic');

// 可以任意命名
const [ 最佳匹配程度, 最佳匹配位置, 是否找到 ] = findPic([43820, 0, 51605, 3794], 'pic');
...
const [ match, loc, find ] = findPic([43820, 0, 51605, 3794], 'pic', 10, 2000);
