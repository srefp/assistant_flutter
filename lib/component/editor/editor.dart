    ...
    return Material(
      child: CodeAutocomplete(
        promptsBuilder: DefaultCodeAutocompletePromptsBuilder(
          directPrompts:
              hintKeys.map((key) => CodeKeywordPrompt(word: key)).toList(),
        ),
        ...
        child: CodeEditor(
          style: CodeEditorStyle(
            ...
            codeTheme: CodeHighlightTheme(
              ...
              theme: {
                'root': TextStyle(
                    backgroundColor: Color(0xff2b2b2b), color: Color(0xffbababa)),
  ...
  InlineSpan createSpan(BuildContext context, String input) {
    ...
    if (prompt is CodeFieldPrompt) {
      return TextSpan(children: [
        span,
        TextSpan(
            text: ' ${prompt.type}', style: style.copyWith(color: Colors.green))
      ]);
    }
