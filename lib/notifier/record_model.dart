...
class RecordModel extends ChangeNotifier {
  ...
  record(EventType eventType, String name, bool down, List<int> coords, MouseEvent? mouseEvent) {
  ...
  /// 记录路线
  void recordRoute(String name, bool down, List<int> coords, MouseEvent? mouseEvent) {
    recordTpc(name, down);
    appendDelay(getDelay());
